...
def process_poses(poses_in, mean_t, std_t, align_R, align_t, align_s):
    ...
    poses_out[:, 0:3] = poses_in[:, [3, 7, 11]] # get translation
...
#       print(q)
#       q0 = np.sqrt(np.trace(R)+1)*0.5
#       q2 = np.array([q0, (R[1,2]-R[2,1])/(4*q0), (R[2,0]-R[0,2])/(4*q0), (R[0,1]-R[1,0])/(4*q0)])
#       q3 = q2/txq.qnorm(q2)
#       print(q2,q3)
